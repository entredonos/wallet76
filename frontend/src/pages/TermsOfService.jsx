...
function getContent(lang) {
  if (lang === "pt") return {
    ...
    sections: [
      ...
      { heading: "6. Subscrição e Faturação", body: "O Wallet76 oferece um plano gratuito e uma subscrição Pro, faturada mensal ou anualmente. Ao subscrever, autoriza a cobrança recorrente através do método de pagamento fornecido; as subscrições renovam-se automaticamente no início de cada período, salvo cancelamento. Pode cancelar a qualquer momento nas definições da conta ou contactando support@wallet76.com — o cancelamento impede renovações futuras e mantém o acesso Pro até ao fim do período já pago, sem reembolso proporcional do período em curso. Os consumidores na União Europeia dispõem de um direito de retração de 14 dias após a subscrição; contudo, ao ativar de imediato o acesso Pro, solicita o início da prestação e reconhece que o direito de retração se extingue quando o serviço é totalmente prestado. Pedidos de reembolso podem ser enviados para support@wallet76.com e são analisados de acordo com a lei aplicável. Os preços podem ser alterados mediante aviso prévio razoável, aplicando-se as novas condições apenas a períodos de faturação subsequentes." },
  ...
  if (lang === "fr") return {
    ...
    sections: [
      ...
      { heading: "6. Abonnement et Facturation", body: "Wallet76 propose un niveau gratuit et un abonnement Pro, facturé mensuellement ou annuellement. En souscrivant, vous autorisez le prélèvement récurrent sur le moyen de paiement fourni ; les abonnements se renouvellent automatiquement au début de chaque période, sauf résiliation. Vous pouvez résilier à tout moment dans les paramètres du compte ou en écrivant à support@wallet76.com — la résiliation empêche les renouvellements futurs et conserve l’accès Pro jusqu’à la fin de la période déjà payée, sans remboursement proportionnel de la période en cours. Les consommateurs de l’Union européenne disposent d’un droit de rétractation de 14 jours après la souscription ; toutefois, en activant immédiatement l’accès Pro, vous demandez le début de l’exécution et reconnaissez que ce droit s’éteint une fois le service pleinement exécuté. Les demandes de remboursement peuvent être adressées à support@wallet76.com et sont examinées conformément au droit applicable. Les prix peuvent être modifiés moyennant un préavis raisonnable, les nouvelles conditions ne s’appliquant qu’aux périodes de facturation ultérieures." },
  ...
  if (lang === "de") return {
    ...
    sections: [
      ...
      { heading: "6. Abonnement und Abrechnung", body: "Wallet76 bietet eine kostenlose Version und ein Pro-Abonnement, das monatlich oder jährlich abgerechnet wird. Mit dem Abschluss ermächtigen Sie uns zur wiederkehrenden Abbuchung über das angegebene Zahlungsmittel; Abonnements verlängern sich zu Beginn jeder Periode automatisch, sofern nicht gekündigt wird. Sie können jederzeit in den Kontoeinstellungen oder per E-Mail an support@wallet76.com kündigen — die Kündigung verhindert künftige Verlängerungen und der Pro-Zugang bleibt bis zum Ende der bereits bezahlten Periode bestehen, ohne anteilige Rückerstattung der laufenden Periode. Verbraucher in der Europäischen Union haben nach dem Abschluss ein 14-tägiges Widerrufsrecht; durch die sofortige Aktivierung des Pro-Zugangs verlangen Sie jedoch den Beginn der Leistung und erkennen an, dass das Widerrufsrecht mit vollständiger Erbringung der Leistung erlischt. Rückerstattungsanträge können an support@wallet76.com gerichtet werden und werden nach geltendem Recht geprüft. Preise können mit angemessener Vorankündigung geändert werden, wobei die neuen Bedingungen nur für nachfolgende Abrechnungsperioden gelten." },
  ...
  if (lang === "it") return {
    ...
    sections: [
      ...
      { heading: "6. Abbonamento e Fatturazione", body: "Wallet76 offre un piano gratuito e un abbonamento Pro, fatturato mensilmente o annualmente. Sottoscrivendo, autorizzi l’addebito ricorrente sul metodo di pagamento fornito; gli abbonamenti si rinnovano automaticamente all’inizio di ogni periodo, salvo disdetta. Puoi disdire in qualsiasi momento dalle impostazioni dell’account o scrivendo a support@wallet76.com — la disdetta impedisce i rinnovi futuri e mantiene l’accesso Pro fino al termine del periodo già pagato, senza rimborso proporzionale del periodo in corso. I consumatori dell’Unione Europea dispongono di un diritto di recesso di 14 giorni dalla sottoscrizione; tuttavia, attivando immediatamente l’accesso Pro, richiedi l’inizio della prestazione e riconosci che tale diritto si estingue una volta che il servizio è stato pienamente eseguito. Le richieste di rimborso possono essere inviate a support@wallet76.com e sono valutate conformemente alla legge applicabile. I prezzi possono essere modificati con un ragionevole preavviso, applicandosi le nuove condizioni solo ai periodi di fatturazione successivi." },
  ...
  if (lang === "es") return {
    ...
    sections: [
      ...
      { heading: "6. Suscripción y Facturación", body: "Wallet76 ofrece un plan gratuito y una suscripción Pro, facturada mensual o anualmente. Al suscribirte, autorizas el cobro recurrente en el método de pago proporcionado; las suscripciones se renuevan automáticamente al inicio de cada período, salvo cancelación. Puedes cancelar en cualquier momento en los ajustes de la cuenta o escribiendo a support@wallet76.com — la cancelación impide futuras renovaciones y mantiene el acceso Pro hasta el final del período ya pagado, sin reembolso proporcional del período en curso. Los consumidores de la Unión Europea disponen de un derecho de desistimiento de 14 días tras la suscripción; no obstante, al activar de inmediato el acceso Pro, solicitas el inicio de la prestación y reconoces que dicho derecho se extingue una vez que el servicio se ha ejecutado por completo. Las solicitudes de reembolso pueden enviarse a support@wallet76.com y se evalúan conforme a la ley aplicable. Los precios pueden modificarse con un preaviso razonable, aplicándose las nuevas condiciones solo a períodos de facturación posteriores." },
  ...
  return {
    ...
    sections: [
      ...
      { heading: "6. Subscription and Billing", body: "Wallet76 offers a free tier and a Pro subscription, billed monthly or annually. By subscribing, you authorise recurring charges to the payment method provided; subscriptions renew automatically at the start of each period unless cancelled. You may cancel at any time in your account settings or by emailing support@wallet76.com — cancellation stops future renewals and keeps Pro access until the end of the period already paid for, with no pro-rata refund of the current period. Consumers in the European Union have a 14-day right of withdrawal after subscribing; however, by activating Pro access immediately you request that performance begin and acknowledge that this right is lost once the service has been fully performed. Refund requests may be sent to support@wallet76.com and are reviewed in accordance with applicable law. Prices may change with reasonable prior notice, with new terms applying only to subsequent billing periods." },
