...
function getContent(lang) {
  if (lang === "pt") return {
    ...
    sections: [
      ...
      { heading: "4. Responsabilidades da Conta", body: "É responsável pela confidencialidade das suas credenciais e por toda a atividade na sua conta. Notifique-nos imediatamente de qualquer utilização não autorizada em support@wallet76.app." },
      ...
      { heading: "6. Subscrição e Faturação", body: "O Wallet76 oferece um plano gratuito e uma subscrição Pro faturada mensalmente ou anualmente. As subscrições renovam automaticamente. Reembolsos analisados caso a caso." },
      ...
      { heading: "11. Lei Aplicável", body: "Estes Termos são regidos pelas leis da União Europeia e de Portugal." },
      ...
      { heading: "13. Contacto", body: "Dúvidas? Contacte-nos em support@wallet76.app." },
    ],
  };
  if (lang === "fr") return {
    ...
    sections: [
      ...
      { heading: "4. Responsabilités du Compte", body: "Vous êtes responsable de la confidentialité de vos identifiants. Informez-nous immédiatement de toute utilisation non autorisée à support@wallet76.app." },
      ...
      { heading: "6. Abonnement et Facturation", body: "Wallet76 propose un niveau gratuit et un abonnement Pro mensuel ou annuel. Les abonnements se renouvellent automatiquement. Les remboursements sont traités au cas par cas." },
      ...
      { heading: "11. Droit Applicable", body: "Ces Conditions sont régies par le droit de l'Union Européenne et le droit portugais." },
      ...
      { heading: "13. Contact", body: "Questions ? Contactez-nous à support@wallet76.app." },
    ],
  };
  if (lang === "de") return {
    ...
    sections: [
      ...
      { heading: "4. Kontoverantwortung", body: "Sie sind für die Vertraulichkeit Ihrer Zugangsdaten verantwortlich. Informieren Sie uns unverzüglich über unbefugte Nutzung unter support@wallet76.app." },
      ...
      { heading: "6. Abonnement und Abrechnung", body: "Wallet76 bietet eine kostenlose Version und ein Pro-Abonnement. Abonnements verlängern sich automatisch. Rückerstattungen werden fallweise bearbeitet." },
      ...
      { heading: "11. Anwendbares Recht", body: "Diese Bedingungen unterliegen dem Recht der Europäischen Union und dem portugiesischen Recht." },
      ...
      { heading: "13. Kontakt", body: "Fragen? Kontaktieren Sie uns unter support@wallet76.app." },
    ],
  };
  if (lang === "it") return {
    ...
    sections: [
      ...
      { heading: "4. Responsabilità dell'Account", body: "Sei responsabile della riservatezza delle tue credenziali. Notificaci immediatamente qualsiasi uso non autorizzato a support@wallet76.app." },
      ...
      { heading: "6. Abbonamento e Fatturazione", body: "Wallet76 offre un piano gratuito e un abbonamento Pro mensile o annuale. Gli abbonamenti si rinnovano automaticamente. I rimborsi vengono gestiti caso per caso." },
      ...
      { heading: "11. Legge Applicabile", body: "Questi Termini sono regolati dalla legge dell'Unione Europea e dalla legge portoghese." },
      { heading: "12. Modifiche", body: "Potremmo modificare questi Termini con almeno 14 giorni di preavviso per modifiche sostanziali." },
      { heading: "13. Contatto", body: "Domande? Contattaci a support@wallet76.app." },
    ],
  };
  if (lang === "es") return {
    ...
    sections: [
      ...
      { heading: "4. Responsabilidades de la Cuenta", body: "Eres responsable de la confidencialidad de tus credenciales y de toda la actividad bajo tu cuenta. Notifícanos inmediatamente cualquier uso no autorizado en support@wallet76.app." },
      ...
      { heading: "6. Suscripción y Facturación", body: "Wallet76 ofrece un plan gratuito y una suscripción Pro facturada mensual o anualmente. Las suscripciones se renuevan automáticamente salvo cancelación. Los reembolsos se gestionan caso a caso." },
      ...
      { heading: "11. Ley Aplicable", body: "Estos Términos se rigen por las leyes de la Unión Europea y las leyes de Portugal." },
      ...
      { heading: "13. Contacto", body: "¿Preguntas sobre estos Términos? Contacta con nosotros en support@wallet76.app." },
    ],
  };
  return {
    ...
    sections: [
      ...
      { heading: "4. Account Responsibilities", body: "You are responsible for maintaining the confidentiality of your account credentials and for all activity under your account. Notify us immediately of any unauthorised use at support@wallet76.app." },
      ...
      { heading: "6. Subscription and Billing", body: "Wallet76 offers a free tier and a Pro subscription billed monthly or annually. Subscriptions renew automatically unless cancelled. Refunds are handled on a case-by-case basis." },
      ...
      { heading: "11. Governing Law", body: "These Terms are governed by the laws of the European Union and the laws of Portugal." },
      ...
      { heading: "13. Contact", body: "Questions about these Terms? Contact us at support@wallet76.app." },
    ],
  };
}
