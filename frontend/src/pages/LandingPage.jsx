...
const COPY = {
  en: {
    ...
    free_limits: ["No broker sync","No analytics","No watchlist","No portfolio sharing"],
  ...
  pt: {
    ...
    free_limits: ["Sem sincronização com brokers","Sem análises avançadas","Sem watchlist","Sem partilha de carteira"],
  ...
  fr: {
    ...
    free_limits: ["Sans synchro courtiers","Sans analyses avancées","Sans watchlist","Sans partage de portefeuille"],
  ...
  de: {
    ...
    free_limits: ["Keine Broker-Synchronisierung","Keine Analysen","Keine Watchlist","Keine Portfolio-Freigabe"],
  ...
  it: {
    ...
    free_limits: ["Nessuna sincronizzazione broker","Nessuna analisi avanzata","Nessuna watchlist","Nessuna condivisione portafoglio"],
  ...
  es: {
    ...
    free_limits: ["Sin sincronización con brokers","Sin análisis avanzados","Sin watchlist","Sin compartir portafolio"],
