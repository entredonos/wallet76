...
const COPY = {
  en: {
    nav_features: "Features", nav_security: "Security", nav_pricing: "Pricing", nav_downloads: "Apps", nav_referral: "Invite & Earn", nav_learn: "Learn",
    ...
    features: [
      ...
      { title: "Broker & Exchange Sync", body: "Connect DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com and Gate.io directly. Or import from any other broker via CSV or XLSX — we support all major export formats." },
      ...
      { title: "Dividend Calendar", body: "See every upcoming dividend from your holdings on a calendar and agenda — ex-dividend and payment dates, estimated income per month, and totals in your base currency." },
      { title: "Target Allocation & Rebalancing", body: "Set your ideal mix by asset class and per asset, lock the ones you're sure about and let the rest auto-balance. Clear Buy/Hold guidance shows exactly where you're over- or under-weight." },
    ],
    ...
    security: [
      { title: "Encryption, End to End", body: "Every broker API key and credential is encrypted (AES-256-GCM) with a key unique to your account before it ever touches storage — even a database-only breach leaves it unreadable. Passwords are never stored in plain text either: we use bcrypt with an adaptive cost factor, the industry standard." },
    ...
    stats: [
      ...
      { value: "14+", label: "Broker integrations" },
    ...
    free_features: ["1 portfolio wallet","Up to 15 assets","3 price alerts (email)","Real-time price tracking","Transaction history","6 languages & 4 currencies","Basic dashboard"],
    free_limits: ["No broker sync","No analytics","No portfolio sharing"],
    pro_features: ["Unlimited wallets","Unlimited assets","Unlimited alerts (email, Telegram & push)","14 broker & exchange integrations","Advanced analytics (CAGR, Sharpe, drawdown)","Portfolio sharing link","CSV / XLSX import","Priority support","30-day free trial"],
    ...
    sync_sub: "Connect DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com or Gate.io once — every new trade shows up on its own. Anything else imports from CSV or XLSX in seconds.",
  ...
  pt: {
    nav_features: "Funcionalidades", nav_security: "Segurança", nav_pricing: "Preços", nav_downloads: "Apps", nav_referral: "Convida e Ganha", nav_learn: "Aprender",
    ...
    features: [
      ...
      { title: "Sincronização com Brokers", body: "Ligue diretamente o DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com e Gate.io. Ou importe de qualquer outro broker via CSV ou XLSX — suportamos todos os formatos de exportação principais." },
      ...
      { title: "Calendário de Dividendos", body: "Veja todos os próximos dividendos das suas posições em calendário e agenda — datas ex-dividendo e de pagamento, rendimento estimado por mês e totais na sua moeda base." },
      { title: "Alocação-Alvo e Rebalanceamento", body: "Define a percentagem ideal por classe e por ativo, fixa os que tens a certeza e deixa o resto equilibrar-se sozinho. A orientação Comprar/Aguardar mostra exatamente onde estás acima ou abaixo do alvo." },
    ],
    ...
    security: [
      { title: "Encriptação de Ponta a Ponta", body: "Cada chave API de broker e credencial sensível é encriptada (AES-256-GCM) com uma chave única da tua conta antes de sequer tocar no armazenamento — mesmo um acesso só à base de dados deixa-as ilegíveis. As passwords também nunca são guardadas em texto simples: usamos bcrypt com fator de custo adaptativo, o padrão da indústria." },
    ...
    stats: [
      ...
      { value: "14+", label: "Integrações de brokers" },
    ...
    free_features: ["1 carteira","Até 15 ativos","3 alertas de preço (email)","Preços em tempo real","Histórico de transações","6 línguas e 4 moedas","Dashboard básico"],
    free_limits: ["Sem sincronização com brokers","Sem análises avançadas","Sem partilha de carteira"],
    pro_features: ["Carteiras ilimitadas","Ativos ilimitados","Alertas ilimitados (email, Telegram e push)","14 integrações de brokers/exchanges","Análises avançadas (CAGR, Sharpe, drawdown)","Link de partilha de carteira","Importação CSV / XLSX","Suporte prioritário","30 dias de teste grátis"],
    ...
    sync_sub: "Liga o DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com ou Gate.io uma vez — cada nova transação aparece sozinha. O resto importa-se por CSV ou XLSX em segundos.",
  ...
  fr: {
    nav_features: "Fonctionnalités", nav_security: "Sécurité", nav_pricing: "Tarifs", nav_downloads: "Apps", nav_referral: "Parrainage", nav_learn: "Apprendre",
    ...
    features: [
      ...
      { title: "Synchronisation Courtiers", body: "Connectez directement DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com et Gate.io. Ou importez depuis tout autre courtier via CSV ou XLSX." },
      ...
      { title: "Calendrier des Dividendes", body: "Visualisez tous les dividendes à venir de vos positions dans un calendrier et une liste — dates ex-dividende et de versement, revenu estimé par mois et totaux dans votre devise de base." },
      { title: "Allocation Cible et Rééquilibrage", body: "Définissez votre répartition idéale par classe d'actifs et par actif, verrouillez ceux dont vous êtes sûr et laissez le reste s'équilibrer automatiquement. Une orientation Acheter/Attendre montre exactement où vous êtes sur- ou sous-pondéré." },
    ],
    ...
    security: [
      { title: "Chiffrement de Bout en Bout", body: "Chaque clé API de courtier et identifiant sensible est chiffré (AES-256-GCM) avec une clé unique à votre compte avant même de toucher au stockage — même une brèche limitée à la base de données les rend illisibles. Les mots de passe ne sont jamais stockés en clair non plus : nous utilisons bcrypt avec un facteur de coût adaptatif, la référence du secteur." },
    ...
    stats: [
      ...
      { value: "14+", label: "Intégrations de courtiers" },
    ...
    free_features: ["1 portefeuille","Jusqu'à 15 actifs","3 alertes de prix (e-mail)","Suivi des prix en temps réel","Historique des transactions","6 langues et 4 devises","Tableau de bord de base"],
    free_limits: ["Sans synchro courtiers","Sans analyses avancées","Sans partage de portefeuille"],
    pro_features: ["Portefeuilles illimités","Actifs illimités","Alertes illimitées (e-mail, Telegram et push)","14 intégrations courtiers/exchanges","Analyses avancées (CAGR, Sharpe, drawdown)","Lien de partage de portefeuille","Import CSV / XLSX","Support prioritaire","30 jours d'essai gratuit"],
    ...
    sync_sub: "Connectez DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com ou Gate.io une fois — chaque nouvelle transaction apparaît toute seule. Le reste s'importe via CSV ou XLSX en quelques secondes.",
  ...
  de: {
    nav_features: "Funktionen", nav_security: "Sicherheit", nav_pricing: "Preise", nav_downloads: "Apps", nav_referral: "Empfehlen & Verdienen", nav_learn: "Lernen",
    ...
    features: [
      ...
      { title: "Broker- und Exchange-Synchronisierung", body: "Verbinden Sie DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com und Gate.io direkt. Oder importieren Sie von jedem anderen Broker per CSV oder XLSX." },
      ...
      { title: "Dividendenkalender", body: "Sehen Sie alle anstehenden Dividenden Ihrer Positionen in Kalender und Agenda — Ex-Tag und Zahltag, geschätzter Ertrag pro Monat und Summen in Ihrer Basiswährung." },
      { title: "Zielallokation und Rebalancing", body: "Legen Sie Ihre ideale Aufteilung pro Anlageklasse und pro Wert fest, fixieren Sie die sicheren und lassen Sie den Rest automatisch ausbalancieren. Eine Kaufen/Halten-Orientierung zeigt genau, wo Sie über- oder untergewichtet sind." },
    ],
    ...
    stats: [
      ...
      { value: "14+", label: "Broker-Integrationen" },
    ...
    free_features: ["1 Portfolio-Depot","Bis zu 15 Assets","3 Preisalarme (E-Mail)","Echtzeit-Preisverfolgung","Transaktionshistorie","6 Sprachen und 4 Währungen","Basis-Dashboard"],
    free_limits: ["Keine Broker-Synchronisierung","Keine Analysen","Keine Portfolio-Freigabe"],
    pro_features: ["Unbegrenzte Depots","Unbegrenzte Assets","Unbegrenzte Alarme (E-Mail, Telegram und Push)","14 Broker/Exchange-Integrationen","Fortgeschrittene Analysen (CAGR, Sharpe, Drawdown)","Portfolio-Freigabelink","CSV/XLSX-Import","Prioritäts-Support","30 Tage kostenlose Testversion"],
    ...
    sync_sub: "Verbinden Sie DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com oder Gate.io einmal — jeder neue Trade erscheint von selbst. Alles andere importieren Sie in Sekunden per CSV oder XLSX.",
  ...
  it: {
    nav_features: "Funzionalità", nav_security: "Sicurezza", nav_pricing: "Prezzi", nav_downloads: "App", nav_referral: "Invita e Guadagna", nav_learn: "Impara",
    ...
    features: [
      ...
      { title: "Sincronizzazione Broker ed Exchange", body: "Connetti direttamente DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com e Gate.io. O importa da qualsiasi altro broker tramite CSV o XLSX." },
      ...
      { title: "Calendario Dividendi", body: "Visualizza tutti i prossimi dividendi delle tue posizioni in calendario e agenda — date ex-dividendo e di pagamento, reddito stimato per mese e totali nella tua valuta base." },
      { title: "Allocazione Target e Ribilanciamento", body: "Imposta la ripartizione ideale per classe di attività e per singolo asset, blocca quelli di cui sei sicuro e lascia che il resto si bilanci da solo. L'indicazione Compra/Attendi mostra esattamente dove sei sovra- o sotto-pesato." },
    ],
    ...
    security: [
      { title: "Crittografia End-to-End", body: "Ogni chiave API broker e credenziale sensibile è crittografata (AES-256-GCM) con una chiave unica del tuo account prima ancora di toccare l'archiviazione — anche una violazione limitata al database le lascia illeggibili. Anche le password non vengono mai archiviate in chiaro: usiamo bcrypt con fattore di costo adattivo, lo standard del settore." },
    ...
    stats: [
      ...
      { value: "14+", label: "Integrazioni broker" },
    ...
    free_features: ["1 portafoglio","Fino a 15 asset","3 avvisi di prezzo (email)","Tracciamento prezzi in tempo reale","Storico transazioni","6 lingue e 4 valute","Dashboard di base"],
    free_limits: ["Nessuna sincronizzazione broker","Nessuna analisi avanzata","Nessuna condivisione portafoglio"],
    pro_features: ["Portafogli illimitati","Asset illimitati","Avvisi illimitati (email, Telegram e push)","14 integrazioni broker/exchange","Analisi avanzate (CAGR, Sharpe, drawdown)","Link di condivisione portafoglio","Import CSV / XLSX","Supporto prioritario","30 giorni di prova gratuita"],
    ...
    sync_sub: "Collega DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com o Gate.io una volta — ogni nuova operazione appare da sola. Il resto si importa via CSV o XLSX in pochi secondi.",
  ...
  es: {
    nav_features: "Funcionalidades", nav_security: "Seguridad", nav_pricing: "Precios", nav_downloads: "Apps", nav_referral: "Invita y Gana", nav_learn: "Aprender",
    ...
    features: [
      ...
      { title: "Sincronización con Brokers", body: "Conecta directamente DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com y Gate.io. O importa desde cualquier otro broker mediante CSV o XLSX — soportamos todos los formatos de exportación principales." },
      ...
      { title: "Calendario de Dividendos", body: "Ve todos los próximos dividendos de tus posiciones en calendario y agenda — fechas ex-dividendo y de pago, ingresos estimados por mes y totales en tu moneda base." },
      { title: "Asignación Objetivo y Rebalanceo", body: "Define tu distribución ideal por clase de activo y por activo, fija los que tengas claros y deja que el resto se equilibre solo. La orientación Comprar/Esperar muestra exactamente dónde estás sobre- o infraponderado." },
    ],
    ...
    security: [
      { title: "Cifrado de Extremo a Extremo", body: "Cada clave API de broker y credencial sensible se cifra (AES-256-GCM) con una clave única de tu cuenta antes incluso de tocar el almacenamiento — incluso una brecha limitada a la base de datos las deja ilegibles. Las contraseñas tampoco se almacenan nunca en texto plano: usamos bcrypt con factor de coste adaptativo, el estándar del sector." },
    ...
    stats: [
      { value: "11", label: "Intervalos de gráfico" },
      { value: "14+", label: "Integraciones de brokers" },
    ...
    free_features: ["1 cartera","Hasta 15 activos","3 alertas de precio (correo)","Seguimiento de precios en tiempo real","Historial de transacciones","6 idiomas y 4 divisas","Dashboard básico"],
    free_limits: ["Sin sincronización con brokers","Sin análisis avanzados","Sin compartir portafolio"],
    pro_features: ["Carteras ilimitadas","Activos ilimitados","Alertas ilimitadas (correo, Telegram y push)","14 integraciones brokers/exchanges","Análisis avanzados (CAGR, Sharpe, drawdown)","Enlace de compartir portafolio","Importación CSV / XLSX","Soporte prioritario","30 días de prueba gratuita"],
    ...
    sync_sub: "Conecta DEGIRO, Interactive Brokers, Trading 212, Binance, Coinbase, Kraken, Bybit, OKX, KuCoin, Bitget, MEXC, Crypto.com o Gate.io una vez — cada nueva operación aparece sola. Todo lo demás se importa por CSV o XLSX en segundos.",
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#08080A]/85 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-2">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-zinc-400">
            ...
            <Link to="/aprender" className="hover:text-white transition-colors">{c.nav_learn}</Link>
