...
const COPY = {
  en: {
    ...
    pro_features: ["Unlimited wallets","Unlimited assets","Unlimited alerts (email, Telegram & push)","14 broker & exchange integrations","Advanced analytics (CAGR, Sharpe, drawdown)","Watchlist & market movers","Deep asset research & analyst data","Portfolio sharing link","CSV / XLSX import","Market news feed","Priority support","30-day free trial"],
  ...
  pt: {
    ...
    pro_features: ["Carteiras ilimitadas","Ativos ilimitados","Alertas ilimitados (email, Telegram e push)","14 integrações de brokers/exchanges","Análises avançadas (CAGR, Sharpe, drawdown)","Watchlist e movers de mercado","Pesquisa de ativos e dados de analistas","Link de partilha de carteira","Importação CSV / XLSX","Feed de notícias financeiras","Suporte prioritário","30 dias de teste grátis"],
  ...
  fr: {
    ...
    pro_features: ["Portefeuilles illimités","Actifs illimités","Alertes illimitées (e-mail, Telegram et push)","14 intégrations courtiers/exchanges","Analyses avancées (CAGR, Sharpe, drawdown)","Watchlist et movers de marché","Recherche d'actifs et données analystes","Lien de partage de portefeuille","Import CSV / XLSX","Fil d'actualités financières","Support prioritaire","30 jours d'essai gratuit"],
  ...
  es: {
    ...
    pro_features: ["Carteras ilimitadas","Activos ilimitados","Alertas ilimitadas (correo, Telegram y push)","14 integraciones brokers/exchanges","Análisis avanzados (CAGR, Sharpe, drawdown)","Watchlist y movers de mercado","Investigación de activos y datos de analistas","Enlace de compartir portafolio","Importación CSV / XLSX","Feed de noticias financieras","Soporte prioritario","30 días de prueba gratuita"],
