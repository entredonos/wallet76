...
const COPY = {
  en: {
    ...
    security: [
      { title: "AES-256 Encryption", body: "Every broker API key and sensitive credential is encrypted with AES-256 before storage. Even if our database were ever compromised, your keys remain completely unreadable." },
      ...
      { title: "Audit Log", body: "Every sensitive action — broker connection, key change, data export — is logged with timestamp and IP. You always know what happened to your account." },
  ...
  pt: {
    ...
    security: [
      { title: "Encriptação AES-256", body: "Cada chave API de broker e credencial sensível é encriptada com AES-256 antes do armazenamento. As suas chaves permanecem completamente ilegíveis mesmo em caso de violação." },
      ...
      { title: "Registo de Auditoria", body: "Cada ação sensível é registada com timestamp e IP. Sabe sempre o que aconteceu na sua conta." },
  ...
  fr: {
    ...
    security: [
      { title: "Chiffrement AES-256", body: "Chaque clé API de courtier et identifiant sensible est chiffré avec AES-256 avant stockage. Même en cas de violation, vos clés restent complètement illisibles." },
      ...
      { title: "Journal d'Audit", body: "Chaque action sensible est enregistrée avec horodatage et IP. Vous savez toujours ce qui s'est passé sur votre compte." },
  ...
  de: {
    ...
    security: [
      { title: "AES-256-Verschlüsselung", body: "Jeder Broker-API-Schlüssel wird vor der Speicherung mit AES-256 verschlüsselt. Selbst bei einem Datenbankbruch bleiben Ihre Schlüssel vollständig unlesbar." },
      ...
      { title: "Prüfprotokoll", body: "Jede sensible Aktion wird mit Zeitstempel und IP protokolliert. Sie wissen immer, was mit Ihrem Konto passiert ist." },
  ...
  it: {
    ...
    security: [
      { title: "Crittografia AES-256", body: "Ogni chiave API broker e credenziale sensibile è crittografata con AES-256 prima dell'archiviazione. Anche in caso di violazione, le tue chiavi rimangono completamente illeggibili." },
      ...
      { title: "Log di Audit", body: "Ogni azione sensibile è registrata con timestamp e IP. Sai sempre cosa è successo al tuo account." },
  ...
  es: {
    ...
    security: [
      { title: "Cifrado AES-256", body: "Cada clave API de broker y credencial sensible se cifra con AES-256 antes del almacenamiento. Incluso en caso de brecha, tus claves permanecen completamente ilegibles." },
      ...
      { title: "Registro de Auditoría", body: "Cada acción sensible se registra con marca de tiempo e IP. Siempre sabes qué ha pasado en tu cuenta." },
