...
function getContent(lang) {
  if (lang === "pt") return {
    ...
    sections: [
      { heading: "1. Quem Somos", body: "O Wallet76 é uma aplicação de acompanhamento de carteiras de investimento. O responsável pelo tratamento dos dados é José Oliveira, em Moudon, cantão de Vaud, Suíça. Contacto: support@wallet76.com." },
      ...
      { heading: "6. Os Seus Direitos (RGPD e nLPD)", body: "Ao abrigo do RGPD tem direito a: aceder aos seus dados, corrigir dados inexatos, solicitar eliminação, opor-se ao tratamento e portabilidade dos dados. Como o responsável pelo tratamento está sediado na Suíça, aplica-se igualmente a Lei Federal suíça de Proteção de Dados (nLPD); os utilizadores no Espaço Económico Europeu mantêm todos os direitos previstos no RGPD. Contacte-nos em support@wallet76.com." },
  ...
  if (lang === "fr") return {
    ...
    sections: [
      { heading: "1. Qui Sommes-Nous", body: "Wallet76 est une application de suivi de portefeuille d'investissement. Le responsable du traitement des données est José Oliveira, à Moudon, canton de Vaud, Suisse. Contact : support@wallet76.com." },
      ...
      { heading: "6. Vos Droits (RGPD et nLPD)", body: "Conformément au RGPD, vous avez le droit d'accéder à vos données, de les corriger, de les supprimer, de vous opposer au traitement et à la portabilité. Le responsable du traitement étant établi en Suisse, la loi fédérale suisse sur la protection des données (nLPD) s'applique également ; les utilisateurs de l'EEE conservent l'ensemble des droits prévus par le RGPD. Contactez-nous à support@wallet76.com." },
  ...
  if (lang === "de") return {
    ...
    sections: [
      { heading: "1. Wer Wir Sind", body: "Wallet76 ist eine Anwendung zur Verfolgung von Anlageportfolios. Verantwortlicher für die Datenverarbeitung ist José Oliveira, in Moudon, Kanton Waadt, Schweiz. Kontakt: support@wallet76.com." },
      ...
      { heading: "6. Ihre Rechte (DSGVO und revDSG)", body: "Gemäß DSGVO haben Sie das Recht auf Auskunft, Berichtigung, Löschung, Widerspruch und Datenübertragbarkeit. Da der Verantwortliche in der Schweiz ansässig ist, gilt zudem das schweizerische Datenschutzgesetz (revDSG); Nutzer im EWR behalten alle Rechte nach der DSGVO. Kontaktieren Sie uns unter support@wallet76.com." },
  ...
  if (lang === "it") return {
    ...
    sections: [
      { heading: "1. Chi Siamo", body: "Wallet76 è un'applicazione per il monitoraggio del portafoglio di investimenti. Il titolare del trattamento dei dati è José Oliveira, a Moudon, Canton Vaud, Svizzera. Contatto: support@wallet76.com." },
      ...
      { heading: "6. I Tuoi Diritti (GDPR e nLPD)", body: "Ai sensi del GDPR hai il diritto di accedere, correggere, cancellare i tuoi dati, opporti al trattamento e alla portabilità. Poiché il titolare del trattamento ha sede in Svizzera, si applica anche la Legge federale svizzera sulla protezione dei dati (nLPD); gli utenti nel SEE conservano tutti i diritti previsti dal GDPR. Contattaci all'indirizzo support@wallet76.com." },
  ...
  if (lang === "es") return {
    ...
    sections: [
      { heading: "1. Quiénes Somos", body: "Wallet76 es una aplicación de seguimiento de portafolio de inversiones. El responsable del tratamiento de los datos es José Oliveira, en Moudon, cantón de Vaud, Suiza. Contacto: support@wallet76.com." },
      ...
      { heading: "6. Tus Derechos (RGPD y nLPD)", body: "Bajo el RGPD tienes derecho a: acceder a tus datos, corregir datos inexactos, solicitar la eliminación, oponerte al tratamiento y a la portabilidad. Dado que el responsable del tratamiento tiene su sede en Suiza, también se aplica la Ley Federal suiza de Protección de Datos (nLPD); los usuarios del EEE conservan todos los derechos previstos en el RGPD. Contacta con nosotros en support@wallet76.com." },
  ...
  return {
    ...
    sections: [
      { heading: "1. Who We Are", body: "Wallet76 is a personal finance and portfolio tracking application. The data controller is José Oliveira, based in Moudon, Canton of Vaud, Switzerland. Our registered contact email is support@wallet76.com." },
      ...
      { heading: "6. Your Rights (GDPR & FADP)", body: "Under the GDPR you have the right to: access your personal data; request correction of inaccurate data; request erasure; object to processing; and data portability. As the data controller is based in Switzerland, the Swiss Federal Act on Data Protection (revFADP) also applies; users in the EEA retain all rights under the GDPR. Email us at support@wallet76.com." },
