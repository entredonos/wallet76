...
function getContent(lang) {
  if (lang === "pt") return {
    ...
    sections: [
      { heading: "1. Quem Somos", body: "O Wallet76 é uma aplicação de acompanhamento de carteiras de investimento. Contacto: support@wallet76.app." },
      ...
      { heading: "6. Os Seus Direitos (RGPD)", body: "Ao abrigo do RGPD tem direito a: aceder aos seus dados, corrigir dados inexatos, solicitar eliminação, opor-se ao tratamento e portabilidade dos dados. Contacte-nos em privacy@wallet76.app." },
      ...
      { heading: "10. Contacto", body: "Dúvidas? Contacte-nos em privacy@wallet76.app." },
    ],
  };
  if (lang === "fr") return {
    ...
    sections: [
      { heading: "1. Qui Sommes-Nous", body: "Wallet76 est une application de suivi de portefeuille d'investissement. Contact : support@wallet76.app." },
      ...
      { heading: "6. Vos Droits (RGPD)", body: "Conformément au RGPD, vous avez le droit d'accéder à vos données, de les corriger, de les supprimer, de vous opposer au traitement et à la portabilité. Contactez-nous à privacy@wallet76.app." },
      ...
      { heading: "10. Contact", body: "Questions ? Contactez-nous à privacy@wallet76.app." },
    ],
  };
  if (lang === "de") return {
    ...
    sections: [
      { heading: "1. Wer Wir Sind", body: "Wallet76 ist eine Anwendung zur Verfolgung von Anlageportfolios. Kontakt: support@wallet76.app." },
      ...
      { heading: "6. Ihre Rechte (DSGVO)", body: "Gemäß DSGVO haben Sie das Recht auf Auskunft, Berichtigung, Löschung, Widerspruch und Datenübertragbarkeit. Kontaktieren Sie uns unter privacy@wallet76.app." },
      ...
      { heading: "10. Kontakt", body: "Fragen? Kontaktieren Sie uns unter privacy@wallet76.app." },
    ],
  };
  if (lang === "it") return {
    ...
    sections: [
      { heading: "1. Chi Siamo", body: "Wallet76 è un'applicazione per il monitoraggio del portafoglio di investimenti. Contatto: support@wallet76.app." },
      ...
      { heading: "6. I Tuoi Diritti (GDPR)", body: "Ai sensi del GDPR hai il diritto di accedere, correggere, cancellare i tuoi dati, opporti al trattamento e alla portabilità. Contattaci all'indirizzo privacy@wallet76.app." },
      ...
      { heading: "10. Contatto", body: "Domande? Contattaci a privacy@wallet76.app." },
    ],
  };
  if (lang === "es") return {
    ...
    sections: [
      { heading: "1. Quiénes Somos", body: "Wallet76 es una aplicación de seguimiento de portafolio de inversiones. Contacto: support@wallet76.app." },
      ...
      { heading: "6. Tus Derechos (RGPD)", body: "Bajo el RGPD tienes derecho a: acceder a tus datos, corregir datos inexactos, solicitar la eliminación, oponerte al tratamiento y a la portabilidad. Contacta con nosotros en privacy@wallet76.app." },
      ...
      { heading: "10. Contacto", body: "¿Preguntas? Contacta con nosotros en privacy@wallet76.app." },
    ],
  };
  return {
    ...
    sections: [
      { heading: "1. Who We Are", body: "Wallet76 is a personal finance and portfolio tracking application. Our registered contact email is support@wallet76.app." },
      ...
      { heading: "6. Your Rights (GDPR)", body: "Under the GDPR you have the right to: access your personal data; request correction of inaccurate data; request erasure; object to processing; and data portability. Email us at privacy@wallet76.app." },
      ...
      { heading: "10. Contact", body: "Questions about this policy? Contact us at privacy@wallet76.app." },
    ],
  };
}
