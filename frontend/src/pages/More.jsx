...
import { Receipt, Eye, BarChart2, PieChart, Coins, Newspaper, Link2, Settings, ChevronRight } from "lucide-react";
...
const ITEMS = [
  ...
  { to: "/alocacao", icon: PieChart, labelKey: "nav.allocation", color: "text-blue-400" },
