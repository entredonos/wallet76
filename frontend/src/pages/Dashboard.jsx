      ...
      <div className="flex items-start justify-between gap-3 flex-nowrap">
        <div className="min-w-0">
          <h1 className="font-display text-3xl sm:text-4xl font-light tracking-tight text-zinc-50 truncate">
            ...
            <div className="hidden sm:flex flex-wrap items-center gap-x-4 gap-y-1 mt-1.5" data-testid="dashboard-subtitle">
              {selectedWallet ? (
            ...
            {/* Atalhos contextuais Transações/Análise DESTA carteira (8 jul
                ...
                para passar). */}
            {selectedWallet && (
              <div className="hidden sm:flex flex-wrap items-center gap-2 mt-2.5" data-testid="wallet-quicklinks">
