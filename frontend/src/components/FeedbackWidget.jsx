        ...
        >
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-800">
              ...
              <button onClick={close} className="text-zinc-400 hover:text-zinc-300 transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {done ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 px-6 gap-4">
                ...
                <div className="text-zinc-400 text-xs text-center">{t("feedback.thanks_sub") || "O teu contributo ajuda a melhorar a app."}</div>
                <button
                  onClick={close}
