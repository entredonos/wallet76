...
// Captura o ponto ativo do tooltip (funciona com rato E toque) e reporta-o
// para cima. O guarda em onTip (só atualiza quando o label muda) impede o
// ciclo de re-render — testado em ambos.
